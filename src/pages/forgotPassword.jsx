...
export default function ForgetPasswordPage() {
    ...
    function sendOtp() {
        axios.post(import.meta.env.VITE_API_BASE_URL + "/api/users/send-otp", {
            email: email
        }).then((response) => {
    ...
    function verifyOtp() {
        ...
        axios.post(import.meta.env.VITE_API_BASE_URL + "/api/users/reset-password", {
            email: email,
    ...
    return (
        <div className="w-full h-screen flex justify-center items-center bg-[url('/mainbg.jpg')] bg-center bg-cover">
            {
                otpSentStatus ?
                    <div className="w-[400px] h-[500px] bg-white shadow-2xl rounded-xl flex flex-col justify-center items-center p-4">
                        ...
                        <button className="w-full h-[50px] bg-gray-300 text-gray-700 rounded-lg mb-4 hover:bg-gray-400 transition-all duration-300" onClick={() => setOtpSentStatus(false)}>Resend OTP</button>
                    </div> :
                    <div className="w-[400px] h-[500px] bg-white shadow-2xl rounded-xl flex flex-col justify-center items-center p-4">

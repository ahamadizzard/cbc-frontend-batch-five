        ...
        return (
            <div className="min-h-screen bg-background">
                                ...
                                <div className="bg-secondary/10 p-8 rounded-xl border-l-4 border-accent">
                                    ...
                                    <div className="space-y-6">
                                        <div className="flex items-start">
                                            ...
                                            <div>
                                                <h3 className="text-xl font-semibold text-secondary mb-1">Our Location</h3>
                                                <p className="text-gray-700">123 Business Avenue<br />City, State 10001</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex items-start">
                                            ...
                                            <div>
                                                <h3 className="text-xl font-semibold text-secondary mb-1">Phone Numbers</h3>
                                        ...
                                        <div className="flex items-start">
                                            ...
                                            <div>
                                                <h3 className="text-xl font-semibold text-secondary mb-1">Email Addresses</h3>
                                                <p className="text-gray-700">
                                        ...
                                        <div className="flex items-start">
                                            ...
                                            <div>
                                                <h3 className="text-xl font-semibold text-secondary mb-1">Working Hours</h3>
                                                <p className="text-gray-700">
                ...
                <section className="py-16 bg-background">
                    <div className="container mx-auto px-6">
                        <h2 className="text-3xl font-bold text-center text-primary mb-12">Find Us on the Map</h2>
